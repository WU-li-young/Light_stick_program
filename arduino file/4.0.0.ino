...
// [修改點 1] 定義兩個腳位
#define PIN_TOP     8        // 上端訊號腳 (GPIO 8)
#define PIN_BTM     10       // 下端訊號腳 (GPIO 10) - 請確認你的板子有這個腳

#define NUM_LEDS    120      // 總燈數 (60 + 60)
#define HALF_LEDS   60       // 單邊燈數
...
int presetA = 0; int presetB = 0; // 預設 6色輪替
...
void setup() {
  ...
  // [修改點 2] 雙腳位初始化 (Split Strips)
  // 將陣列的前60顆 對應到 PIN_TOP (GPIO 8)
  FastLED.addLeds<LED_TYPE, PIN_TOP, COLOR_ORDER>(leds, 0, HALF_LEDS);
  // 將陣列的後60顆 對應到 PIN_BTM (GPIO 10)
  FastLED.addLeds<LED_TYPE, PIN_BTM, COLOR_ORDER>(leds, HALF_LEDS, HALF_LEDS);
